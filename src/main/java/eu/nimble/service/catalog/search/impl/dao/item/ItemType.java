...
public class ItemType extends Concept implements ICatalogueItem, Serializable {
	...
	/**
	 * The indexed item must have a type value assigned for proper handling of
	 * nested documents
	 */
	...
	/**
	 * Map holding a list of used Unit's for packaging The
	 */
	...
	/**
	 * Read only field - used to provide the manufacturer's details in a search
	 * result
	 */
	 ...
	 * 
	 * @param qualifier
	 *            To be used as dynamic field name in index, see
	 *            {@link #dynamicFieldPart(String)}
	 * @param value
	 ...
	 *            The value of the property
	 * @param meta
	 *            A detailed property description holding multi lingual labels
	 */
	 ...
	 *            {@link #dynamicFieldPart(String)}
	 * @param unit
	 *            Additional qualifier, such as the language
	 * @param value
	 *            The value of the property
	 * @param meta
	 *            A detailed property description holding multi lingual labels
	...
	/**
	 * Setter for the double properties, used for deserializing from JSON. Do
	 * not use directly
	 * 
	 * @param qualifier
	 * @param values
	 ...
	 * 
	 * @param qualifier
	 *            The qualifier to use for the index name and for the mapping to
	 *            the custom property
	 * @param unit
	 *            The unit of the actual usage - full qualifier including unit
	 *            is used for mapping as well
	 * @param meta
	 *            The detailed property description holding multilingual labels
	 * @param valueQualfier
	 *            The basic type of the property, see {@link ValueQualifier} for
	 *            complete list
	 */
	...
	/**
	 * Add a new string property, the text and the language are are combined to
	 * <i>text@language</i>.
	 * 
	 * @param qualifier
	 *            To be used as dynamic field name in index, see
	 ...
	 *            The value of the property
	 * @param meta
	 *            A detailed description of the property including multi lingual
	 *            labels
	 */
	...
	/**
	 * Obtain a multi-lingual property for the given qualifier and the desired
	 * language, <code>null</code> if no value can be found.
	 * 
	 * @param qualifier
	 *            The qualifier used when storing the multi lingual property
	 *            value
	 * @param language
	 *            The language code, such as <i>en</i>, <i>es</i>
	...
	public String getMultiLingualProperty(String qualifier, String language) {
		...
		if (this.stringValue.get(key) != null && !this.stringValue.get(key).isEmpty()) {
			Optional<String> prop = this.stringValue.get(key).stream().filter(new Predicate<String>() {
	 ...
	 * @param language
	 *            The language code, such as <i>en</i>, <i>es</i>
	 * @return A list of multi lingual property values for the desired languag,
	 *         empty list when no value present
	 */
	public List<String> getMultiLingualProperties(String qualifier, String language) {
		String key = dynamicFieldPart(qualifier);
		if (this.stringValue.get(key) != null && !this.stringValue.get(key).isEmpty()) {
			List<String> prop = this.stringValue.get(key).stream().filter(new Predicate<String>() {
	...
	/**
	 * Obtain the collection of numeric properties stored with the provided
	 * <i>qualifier</i>
	 * 
	 * @param qualifier
	 *            The qualifier used when storing the numeric values
	 * @param unit
	 *            The unit extension used when storing the numeric values
	...
	/**
	 * Getter for the boolean properties, used for serializing. The qualifiers
	 * originally used when storing are restored and used as keys.
	 * 
	 * @return
	 */
	...
	/**
	 * Setter for boolean properties, used for deserializing JSON, not intended
	 * to be used directly
	 * 
	 * @param booleanValue
	 */
	...
	public Map<String, Boolean> getBooleanValueDirect() {

		return booleanValue;
	}

	/**
	 * Getter for the string properties, used for serializing. The qualifiers
	 * originally used when storing are restored and used as keys.
	 * 
	 * @return
	 */
	...
	public Map<String, Collection<String>> getStringValueDirect() {

		return stringValue;
	}

	/**
	 * Getter for the double values, used for serializing. The qualifiers
	 * originally used when storing are restored and used as key.
	 * 
	 * @return
	 */
	...
	public Map<String, Collection<Double>> getDoubleValueDirect() {
	 ...
	 *            The boolean value to store
	 * @param meta
	 *            A detailed description of the property holding multilingual
	 *            labels
	 */
	...
	/**
	 * For proper distinction of catalogue items and nested documents, the item
	 * must hava a type field
	 * 
	 * @see #TYPE_VALUE
	 * @return
	 */
	 ...
	 * 
	 * @param unit
	 *            The unit such as <i>Week(s)</i>, <i>Day(s)</i>
	 * @param time
	 *            The amount of the delivery time unit
	 */
	...
	/**
	 * Setter for custom properties, used for deserializing from JSON. Do not
	 * use directly - instead use the addProperty ... methods
	 * <ul>
	...
	/**
	 * Helper method to create the index field's name part and to maintain the
	 * label for the corresponding name map
	 * 
	 * @param keyVal
	 * @param keyMap
	 * @return
	...
	/**
	 * Static helper method transforming a qualifier into a valid dynamic field
	 * part
	 * 
	 * @param qualifier
	 *            The qualifier used when adding dynamic properties
	 */
	...
	/**
	 * Static helper method transforming multiple qualifier into a valid dynamic
	 * field part
	 * 
	 * @param strings
	 *            The qualifiers used when adding dynamic properties
	 * @return
	 */
